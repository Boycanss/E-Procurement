...
class User extends CI_Controller {
	...
	public function blackuser(){
            $this->data['title'] = 'Data Barang - E-Procurement';
            $this->data['isi']  = 'User/black_v';
            $this->data['user'] = $this -> M_user -> blackuser();
            $this->load->view('layout/tema',$this->data);
	}
	
	public function panitiagudang(){
            $this->data['title'] = 'Data Barang - E-Procurement';
            $this->data['isi']  = 'User/panitiagudang_v';
            $this->data['user'] = $this -> M_user -> panitiagudang();
            $this->load->view('layout/tema',$this->data);
	}
	
	public function panitiapurchasing(){
            $this->data['title'] = 'Data Barang - E-Procurement';
            $this->data['isi']  = 'User/panitiapurchasing_v';
            $this->data['user'] = $this -> M_user ->panitiapurchasing();
            $this->load->view('layout/tema',$this->data);
	}
	
	public function vendor(){
            $this->data['title'] = 'Data Barang - E-Procurement';
            $this->data['isi']  = 'User/vendor_v';
            $this->data['user'] = $this -> M_user ->vendor();
            $this->load->view('layout/tema',$this->data);
	}
