                        ...
                        <tbody>
                            ...
                            foreach ($supplier as $s) {
                                ...
                                <tr>
									...
									<td><?= ($s -> npwp); ?></td>
                                    <td>
                                        <a href="<?= site_url('rubah-supplier'); ?>/<?= $s -> id_supplier; ?>" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-pencil"></i>&nbsp;</a>
                                        <a href="<?= site_url('hapus-supplier'); ?>/<?= $s -> id_supplier; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
