        ...
        <div class="container">
            ...
            <form class="form-signin" action="<?= site_url('form-register'); ?>" method="POST">
                ...
                <label>No Telepon / Handphone</label>
                    <input type="text" class="form-control" name="nohp" placeholder="No Telepon / Handphone" required >
                <label>Alamat</label>
            	...
            	<label>Email</label>
                    <input type="email" class="form-control" name="email" placeholder="Email" required autofocus>
					 <label>No NPWP</label>
                    <input type="text" class="form-control" name="npwp" placeholder="No NPWP" required >
                ...
                <a href="<?= site_url('awal'); ?>" class="btn btn-sm btn-danger pull-right">Cancel</a>
            </form>
