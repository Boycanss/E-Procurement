    ...
    <div class="panel-body">
        <form action="<?= site_url('tambah-request-barang'); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="stok" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Jumlah Pembelian Barang" required="required" oninvalid="this.setCustomValidity('Isikan Jumlah')" />
            </div>
